...
SpinningCraneKick:Callback("pvp", function(spell)
    if target.distance > 5 or not TigerPalm:InRange(target) then return end
    if target.physImmune then return end
    if gs.comboStrike == spell.id then return end
    if player:HasBuffCount(buffs.danceOfChiJi) < 1 then return end
...
RisingSunKick:Callback("pvp", function(spell)
    if not TigerPalm:InRange(target) then return end
    if gs.comboStrike == spell.id then return end
...
local function PVPRotation()
    ...
    FistsOfFury("st")
    WhirlingDragonPunch("st")
    SpinningCraneKick("pvp")
    SlicingWinds("st")                             
    CelestialConduit("st")                                                 
    TigerPalm("preHotJS")                          
    TigerPalm("st")                                                          
    RisingSunKick("st2")                         
    StrikeOfTheWindlord("st")                      
    StrikeOfTheWindlord("st2")                     
    StrikeOfTheWindlord("st3")                     
    FistsOfFury("st2")                            
    BlackoutKick("st")                            
    TigerPalm("st2")                               
    BlackoutKick("st2")                         
    WhirlingDragonPunch("st2")                                    
    SlicingWinds("st2")                           
    FistsOfFury("st3")                            
    RisingSunKick("st3")                           
    TigerPalm("st3")                               
    BlackoutKick("st3")                          
    SpinningCraneKick("st2")                      
    TigerPalm("st4")                              
    BlackoutKick("st4")                           
    SpinningCraneKick("st3")                       
    WhirlingDragonPunch("st3")                    
    SpinningCraneKick("st4")                     
    BlackoutKick("st5")                            
    BlackoutKick("st6")                            
    TigerPalm("st5")                               
    SpinningCraneKick("st5")                       
    JadefireStomp("st")                           
    ChiBurst("st")                                 
    BlackoutKick("st7")                         
    BlackoutKick("st8")                            
